...
def initialize_conversation():
    ...
    delimiter = "####"
    example_user_req = "I'm looking for a laptop that offers excellent GPU performance, high display quality, great portability, strong multitasking capabilities, and fast processing speed—all within a budget of ₹150,000."
...
def initialize_conv_reco(products):
    ...
    You should also add propoer whitespaces so that all the recommended laptops are properly visible in new lines
    """
    conversation = [{"role": "system", "content": system_message }]
    return conversation
